 ...
 *   PAYTM_AGENT_SKILLS_INSTALL_DIR_CLAUDE_CODE=/custom/path
 *   PAYTM_AGENT_SKILLS_INSTALL_DIR_CURSOR=/custom/path
...
export function resolveInstallDir(target, { cwd = process.cwd() } = {}) {
  const overrideKey = `PAYTM_AGENT_SKILLS_INSTALL_DIR_${target.id.toUpperCase().replace(/-/g, "_")}`;
