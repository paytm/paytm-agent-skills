 ...
 * Resolution order:
 *   1. PAYTM_AGENT_SKILLS_MANIFEST env var (absolute path) - test override
...
export function loadManifest() {
  const path = process.env.PAYTM_AGENT_SKILLS_MANIFEST || resolve(PACKAGE_ROOT, "manifest.json");
  try {
