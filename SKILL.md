...
The mobile + OTP values listed in the *Test Credentials* section exist for **one purpose only**: to satisfy the OTP step inside the **card payment simulator** on staging (e.g. when the test card `4111 1111 1111 1111` triggers a 3DS / OTP prompt, enter mobile `7777777777` and OTP `489871`).
