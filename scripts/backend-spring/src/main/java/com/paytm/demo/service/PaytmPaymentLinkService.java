...
public class PaytmPaymentLinkService {
  ...
  public static final class FetchTransactionsRequest {
    public Long linkId;            // required, sent as JSON number
    public Integer pageNo;         // default 1
    public Integer pageSize;       // default 10
    public Boolean fetchAllTxns;   // default true
  }
